import {CellValueChangedEvent, GridEventDispatcher} from './GridEventDispatcher';

describe('GridEventDispatcher', function () {
  let eventDispatcher: GridEventDispatcher<string>;

  beforeEach(() => {
    jest.clearAllMocks();
    eventDispatcher = new GridEventDispatcher<string>();
  });
  ...
  it('should dispatch event to all registered callbacks', async () => {
    ...
    const event = {} as CellValueChangedEvent<string>;
